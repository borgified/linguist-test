...
error_reporting(0);
    ...
    { 
        echo 'Your PHP is not version 5 or newer, thus you cannot run Kombineer';
...
$title = $langfile['installkombineer'];
...
fwrite($fp, "\n\n #ErrorDocuments \n");
fwrite($fp, "ErrorDocument 400 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 401 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 402 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 403 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 404 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 405 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 406 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 407 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 408 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 409 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 410 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 411 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 412 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 413 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 414 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 500 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 501 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 502 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 503 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 504 ". CL_ROOT."errorcode.php \n");
fwrite($fp, "ErrorDocument 505 ". CL_ROOT."errorcode.php \n");
fclose($fp);
$put = fwrite($file, "$str");
if ($put) {
...
$ins = mysql_query("INSERT INTO settings (name,subtitle,locale,timezone,dateformat,template,mailnotify,mailfrom,mailmethod) VALUES ('Kombineer','Project Management','$locale','$timezone','d.m.Y','standard',1,'kombineer@localhost','mail')");
