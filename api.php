<?php
/*
This is the BETA version of the Kombineer Web API.
It allows you to export data from Kombineer for use in Web applications.
By default the data is sent in XML format. To switch the output to JSON, you have to append mode=json to your queries.

**************
Authorization
**************
In order to prevent data from being served to unauthorized users, the Kombineer web api implements the same logins as Kombineer itself.
You have to append the parameters "username" and "pass" to every query you issue to the API.
These parameters need to contain username and Password of a valid Kombineer user.
...
Usage
******
The Kombineer API can be used by issuing a GET request with several parameters.
